...
class MoreAccFirstForward extends Component {
    render() {
        return (
            <div className="content">
            <div className="container-fluid">
                <div className="row">
                    <h3>&nbsp;&nbsp;More Acc First Forward</h3>
                        ...
                        <div className="card">
                            <div className="card-header">
                                ...
                                <div className="col-xs-12">
                                    ...
                                    <br /><label htmlFor="text">Input X :</label>
                                    <input type="text" className="form-control" name="text" />
                                    <br /><label htmlFor="text">Input H :</label>
                                    <input type="text" className="form-control" name="text" /><br />
                                    <label htmlFor="text">Input Order Differential (Max 4) :</label>
                                    <input type="text" className="form-control" name="text" /><br />
                                </div>
                                <div><br />
...
export default MoreAccFirstForward;